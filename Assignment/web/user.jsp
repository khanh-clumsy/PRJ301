                ...
                <form id="user-form" action="../Assignment/user" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="created-date" name="createdTime" value="<fmt:formatDate value="${user.createdTime}" pattern="dd/MM/yyyy HH:mm:ss"/>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-buttons">
                        ...
                        <button type="button" class="btn btn-neutral" name="delete">Delete account</button>
                    </div>
                </form>
