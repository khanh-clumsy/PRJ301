                            ...
                            <tbody>
                                <c:forEach var="i" begin="0" end="11">
                                    <tr>
                                        ...
                                        <td class="amount income">${incomeData[i]}</td>
                                        <td class="amount expense">${expenseData[i]}</td>
                                        <td class="amount balance">${balanceData[i]}</td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <th>Total</th>
                                    <th class="amount income">${totalIncome}</th>
                                    <th class="amount expense">${totalExpense}</th>
                                    <th class="amount balance">${totalBalance}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
